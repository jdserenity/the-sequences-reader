...
The development of the joint system over time can be described as a rule that maps initial points onto future points. For example, the system could start out in *X*7*Y*2, then develop (under some set of physical laws) into the state *X*3*Y*3 a minute later. Which is to say: if *X* started in state *X*7, and *Y* started in state *Y*2, and we watched it for 1 minute, we would see *X* go to *X*3 and *Y* go to *Y*3. Such are the laws of physics. 

Next, let’s carve out a subspace *S* of the joint system state. The space *S* will be the subspace bounded by *X* being in state *X*1 and *Y* being in states *Y*1 through *Y*4. So the total volume of *S* is 4 states. 
...
The *X* subsystem began in a narrow region of state space—the single state *X*1, in fact—and *Y* began distributed over a wider region of space, states *Y*1 through *Y*4. By interacting with each other, *Y* went into a narrow region, and *X* ended up in a wide region; *but the total phase space volume was conserved*. Four initial states mapped to four end states. 
...
Now let’s say that we’re *uncertain* about the joint system (*X*,*Y*), and our *uncertainty* is described by an equiprobable distribution over S. That is, we’re pretty sure *X* is in state *X*1, but *Y* is equally likely to be in any of the states *Y*1 through *Y*4. If we shut our eyes for a minute and then open them again, we will expect to see *Y* in state *Y*1, but *X* might be in any of the states *X*2 through *X*8. Actually, *X* can only be in *some* of the states *X*2 through *X*8, but it would be too costly to think out exactly which states these might be, so we’ll just say *X*2 through *X*8. 

If you consider the [Shannon entropy][8] of our uncertainty about *X* and *Y* as individual systems, *X* began with 0 bits of entropy because it had a single definite state, and *Y* began with 2 bits of entropy because it was equally likely to be in any of 4 possible states. (There’s no [mutual information][9] between *X* and *Y*. ) A bit of physics occurred, and lo, the entropy of *Y* went to 0, but the entropy of *X* went to log2(7) = 2.8 bits. So entropy was transferred from one system to another, and decreased *within* the *Y* subsystem; but due to the cost of bookkeeping, we didn’t bother to track some information, and hence (from our perspective) the overall entropy increased. 
...
But there is a theorem, Liouville’s Theorem, which can be proven true of our laws of physics, which says that this never happens: [phase space is conserved][10]. 
...
[![][https://www.readthesequences.com/wiki/uploads/star.svg]][12]

[Outside the Laboratory][13] 
...
[Perpetual Motion Beliefs][16]

 [1]: https://www.readthesequences.com/The-Second-Law-Of-Thermodynamics-And-Engines-Of-Cognition?action=source "View PmWiki source for “The Second Law of Thermodynamics, and Engines of Cognition”"
 [2]: https://www.readthesequences.com/The-Second-Law-Of-Thermodynamics-And-Engines-Of-Cognition?action=markdown "View “The Second Law of Thermodynamics, and Engines of Cognition” in Markdown format"
 [3]: https://www.readthesequences.com/Talk/The-Second-Law-Of-Thermodynamics-And-Engines-Of-Cognition "View the Talk page for “The Second Law of Thermodynamics, and Engines of Cognition”"
 ...
 [8]: https://www.readthesequences.com/EntropyAndShortCodes
 [9]: https://www.readthesequences.com/MutualInformationAndDensityInThingspace
 [10]: http://www.av8n.com/physics/phase-space-thin-lens.htm
 [11]: https://www.greaterwrong.com/lw/na/trust_in_bayes/
 [12]: https://www.greaterwrong.com/lw/o5/the_second_law_of_thermodynamics_and_engines_of#comments "View Less Wrong discussion thread for “The Second Law of Thermodynamics, and Engines of Cognition”"
 [13]: https://www.readthesequences.com/OutsideTheLaboratory
 [14]: https://www.readthesequences.com/Book-IV-MereReality
 [15]: https://www.readthesequences.com/LawfulTruthSequence
 [16]: https://www.readthesequences.com/PerpetualMotionBeliefs