...
It occurred to me one day that the standard visualization of the [Prisoner’s Dilemma][8] is fake. 
...
You [can’t avoid hindsight bias][9] by instructing a jury to pretend not to know the real outcome of a set of events. And without a complicated effort backed up by considerable knowledge, a neurologically intact human being cannot pretend to be genuinely, truly selfish. 

We’re born with a sense of fairness, honor, empathy, sympathy, and even altruism—the result of our ancestors’ [adapting][10] to play the *iterated* Prisoner’s Dilemma. We don’t really, truly, absolutely and entirely prefer (*D*,*C*) to (*C*,*C*), though we may entirely prefer (*C*,*C*) to (*D*,*D*) and (*D*,*D*) to (*C*,*D*). The thought of our confederate spending three years in prison does not entirely fail to move us. 
...
And no, you can’t instruct people being initially introduced to game theory to pretend they’re completely selfish—any more than you can instruct human beings being introduced to [anthropomorphism][11] to pretend they’re expected paperclip maximizers. 
...
Player 2: Unfriendly AI, or an alien that [only cares about sorting pebbles][12]. 
...
|         | 1 : *C*                                                 | 1 : *D*                              |
||
| 2 : *C* | (+2 billion human lives saved,   
+2 paperclips gained) | (+3 billion lives,   
+0 paperclips) |
| 2 : *D* | (+0 lives,   
+3 paperclips)                            | (+1 billion lives,   
+1 paperclip)  |
...
So if you’ve ever prided yourself on cooperating in the Prisoner’s Dilemma… or questioned the verdict of classical game theory that the “[rational][13]” choice is to defect… then what do you say to the True Prisoner’s Dilemma above? 

*P.S.:* In fact, I *don’t* think rational agents should always defect in one-shot Prisoner’s Dilemmas, when the other player will cooperate if it expects you to do the same. I think there are situations where two agents can rationally achieve (*C*,*C*) as opposed to (*D*,*D*), and reap the associated benefits.[1][14] 

I’ll explain some of my reasoning when I discuss [Newcomb’s Problem][13]. But we can’t talk about whether [rational cooperation is possible][15] in this dilemma until we’ve dispensed with the visceral sense that the (*C*,*C*) outcome is *nice* or *good* in itself. We have to see past the prosocial [label][16] “mutual cooperation” if we are to grasp the math. If you intuit that (*C*,*C*) trumps (*D*,*D*) from Player 1’s perspective, but don’t intuit that (*D*,*C*) also trumps (*C*,*C*), you haven’t yet appreciated what makes this problem difficult. 

[![][https://www.readthesequences.com/wiki/uploads/star.svg]][17]

  Eliezer Yudkowsky, *Timeless Decision Theory*, Unpublished manuscript (Machine Intelligence Research Institute, Berkeley, CA, 2010), <http://intelligence.org/files/TDT.pdf>. [↩︎][18] 

[Magical Categories][19] 
...
[Sympathetic Minds][22]

 [1]: https://www.readthesequences.com/The-True-Prisoners-Dilemma?action=source "View PmWiki source for “The True Prisoner’s Dilemma”"
 [2]: https://www.readthesequences.com/The-True-Prisoners-Dilemma?action=markdown "View “The True Prisoner’s Dilemma” in Markdown format"
 [3]: https://www.readthesequences.com/Talk/The-True-Prisoners-Dilemma "View the Talk page for “The True Prisoner’s Dilemma”"
 ...
 [8]: https://en.wikipedia.org/wiki/Prisoner%27s%20Dilemma
 [9]: https://www.greaterwrong.com/lw/il/hindsight_bias/
 [10]: https://www.readthesequences.com/AdaptationExecutersNotFitnessMaximizers
 [11]: https://www.readthesequences.com/AnthropomorphicOptimism
 [12]: https://www.readthesequences.com/SortingPebblesIntoCorrectHeaps
 [13]: https://www.readthesequences.com/NewcombsProblemAndRegretOfRationality
 [14]: #footnote1
 [15]: https://intelligence.org/files/TDT.pdf
 [16]: https://www.readthesequences.com/SneakingInConnotations
 [17]: https://www.greaterwrong.com/lw/tn/the_true_prisoners_dilemma#comments "View Less Wrong discussion thread for “The True Prisoner’s Dilemma”"
 [18]: #citation1
 [19]: https://www.readthesequences.com/MagicalCategories
 [20]: https://www.readthesequences.com/Book-V-MereGoodness
 [21]: https://www.readthesequences.com/ValueTheorySequence
 [22]: https://www.readthesequences.com/SympatheticMinds