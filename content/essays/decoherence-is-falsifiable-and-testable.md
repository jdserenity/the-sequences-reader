...
So there do exist observations *B* whose *P*(*B*|*A*deco) is infinitesimal, which would drive *P*(*A*deco|*B*) down to an infinitesimal. 
...
This equation is symmetrical (assuming no probability is [literally equal to 0][8]). There isn’t one *Aj* labeled “old hypothesis” and another *Aj* labeled “new hypothesis.” 
...
This is why we don’t believe that [spaceships blink out of existence when they cross the cosmological horizon][10] relative to us. True, the spaceship’s continued existence doesn’t have an impact on our world. The spaceship’s continued existence isn’t helping to explain the price of gold in London. But we get the invisible spaceship for free as a consequence of general laws that imply conservation of mass and energy. If the spaceship’s continued existence were *not* a deductive consequence of the laws of physics as we presently model them, *then* it would be an additional detail, cost extra probability, and we would have to question why our theory must include this assertion. 
...
[Privileging the Hypothesis][15]

 [1]: https://www.readthesequences.com/Decoherence-Is-Falsifiable-And-Testable?action=source "View PmWiki source for “Decoherence is Falsifiable and Testable”"
 [2]: https://www.readthesequences.com/Decoherence-Is-Falsifiable-And-Testable?action=markdown "View “Decoherence is Falsifiable and Testable” in Markdown format"
 [3]: https://www.readthesequences.com/Talk/Decoherence-Is-Falsifiable-And-Testable "View the Talk page for “Decoherence is Falsifiable and Testable”"
 ...
 [8]: https://www.readthesequences.com/ZeroAndOneAreNotProbabilities
 [9]: https://www.readthesequences.com/ScientificEvidenceLegalEvidenceRationalEvidence
 [10]: https://www.readthesequences.com/BeliefInTheImpliedInvisible
 [11]: https://www.greaterwrong.com/lw/q4/decoherence_is_falsifiable_and_testable#comments "View Less Wrong discussion thread for “Decoherence is Falsifiable and Testable”"
 [12]: https://www.readthesequences.com/DecoherenceIsSimple
 [13]: https://www.readthesequences.com/Book-IV-MereReality
 [14]: https://www.readthesequences.com/QuantumPhysicsAndManyWorldsSequence
 [15]: https://www.readthesequences.com/PrivilegingTheHypothesis