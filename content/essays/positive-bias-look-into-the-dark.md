...
The challenge above is based on a classic experiment due to Peter Wason, the 2-4-6 task. Although subjects given this task typically expressed high confidence in their guesses, only 21% of the subjects successfully guessed the experimenter’s real rule, and replications since then have continued to show success rates of around 20%.[1][8] 
...
Thus, someone who forms the hypothesis “numbers increasing by two” will test the triplet 8-10-12, hear that it fits, and confidently announce the rule. Someone who forms the hypothesis *X*-2*X*-3*X* will test the triplet 3-6-9, discover that it fits, and then announce that rule. 
...
It once seemed that [phlogiston theory][9] could explain a flame going out in an enclosed box (the air became saturated with phlogiston and no more could be released), but phlogiston theory could just as well have explained the flame *not* going out. To notice this, you have to search for negative examples instead of positive examples, look into zero instead of one; which goes against the grain of what experiment has shown to be human instinct. 
...
I have been writing for quite some time now on the notion that [the strength of a hypothesis is what it *can’t* explain, not what it *can*][10]—if you are equally good at explaining any outcome, you have zero knowledge. So to spot an explanation that isn’t helpful, it’s not enough to think of what it does explain very well—you also have to search for results it *couldn’t* explain, and this is the true strength of the theory. 

So I said all this, and then [I challenged the usefulness of “emergence” as a concept][11]. One commenter cited superconductivity and ferromagnetism as examples of emergence. I replied that non-superconductivity and non-ferromagnetism were also examples of emergence, which was the problem. But be it far from me to criticize the commenter! Despite having read extensively on “confirmation bias,” I didn’t spot the “gotcha” in the 2-4-6 task the first time I read about it. It’s a subverbal blink-reaction that has to be retrained. I’m still working on it myself. 
...
Peter Cathcart Wason, “On the Failure to Eliminate Hypotheses in a Conceptual Task,” *Quarterly Journal of Experimental Psychology* 12, no. 3 (1960): 129–140, doi:10.1080/17470216008416717. [↩][13]

[Say Not “Complexity”][14] 
...
[Lawful Uncertainty][17]

 [1]: https://www.readthesequences.com/Positive-Bias-Look-Into-The-Dark?action=source "View PmWiki source for “Positive Bias: Look into the Dark”"
 [2]: https://www.readthesequences.com/Positive-Bias-Look-Into-The-Dark?action=markdown "View “Positive Bias: Look into the Dark” in Markdown format"
 [3]: https://www.readthesequences.com/Talk/Positive-Bias-Look-Into-The-Dark "View the Talk page for “Positive Bias: Look into the Dark”"
 ...
 [8]: #footnote1
 [9]: https://www.readthesequences.com/Fake-Causality
 [10]: https://www.readthesequences.com/Your-Strength-As-A-Rationalist
 [11]: https://www.readthesequences.com/The-Futility-Of-Emergence
 [12]: https://www.greaterwrong.com/lw/iw/positive_bias_look_into_the_dark/#comments "View Less Wrong discussion thread for “Positive Bias: Look into the Dark”"
 [13]: #citation1
 [14]: https://www.readthesequences.com/Say-Not-Complexity
 [15]: https://www.readthesequences.com/Book-I-Map-And-Territory
 [16]: https://www.readthesequences.com/Mysterious-Answers-Sequence
 [17]: https://www.readthesequences.com/Lawful-Uncertainty