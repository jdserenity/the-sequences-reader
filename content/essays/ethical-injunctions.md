...
> 
> —[horrible job interview question][8] 
...
Yea, I have seen [many ways to screw up an AI goal system design][9], resulting in a decision system that decides, given its goals, that the universe ought to be tiled with [tiny molecular smiley-faces][10], or some such. Generally, these deadly suggestions also have the property that the AI will not desire its programmers to fix it. If the AI is *sufficiently* advanced—which it may be even at an intermediate stage—then the AI may also realize that deceiving the programmers, hiding the changes in its thoughts, will help transform the universe into smiley-faces. 
...
During World War II, it became necessary to destroy Germany’s supply of deuterium, a neutron moderator, in order to block their attempts to achieve a fission chain reaction. Their supply of deuterium was coming at this point from a captured facility in Norway. A shipment of heavy water was on board a Norwegian ferry ship, the [SF *Hydro*][14]. Knut Haukelid and three others had slipped on board the ferry in order to sabotage it, when the saboteurs were discovered by the ferry watchman. Haukelid told him that they were escaping the Gestapo, and the watchman immediately agreed to overlook their presence. Haukelid “considered warning their benefactor but decided that might endanger the mission and only thanked him and shook his hand.”[1][15] So the civilian ferry *Hydro* sank in the deepest part of the lake, with eighteen dead and twenty-nine survivors. Some of the Norwegian rescuers felt that the German soldiers present should be left to drown, but this attitude did not prevail, and four Germans were rescued. And that was, effectively, the end of the Nazi atomic weapons program. 
...
I could mention the important times that my naive, idealistic ethical inhibitions have [protected me from *myself*][18], and placed me in a recoverable position, or helped start the recovery, from very deep mistakes I had no clue I was making. And I could ask whether I’ve really advanced so much, and whether it would really be all that wise, to remove the protections that saved me before. 
...
I’ve had to make my ethics *much stricter* than what my parents and [Jerry Pournelle][19] and [Richard Feynman][20] told me not to do. 
...
[![][https://www.readthesequences.com/wiki/uploads/star.svg]][24]

  Richard Rhodes, *The Making of the Atomic Bomb* (New York: Simon & Schuster, 1986). [↩︎][25] 

[Ends Don’t Justify Means (Among Humans)][16] 
...
[Something to Protect][28]

 [1]: https://www.readthesequences.com/Ethical-Injunctions?action=source "View PmWiki source for “Ethical Injunctions”"
 [2]: https://www.readthesequences.com/Ethical-Injunctions?action=markdown "View “Ethical Injunctions” in Markdown format"
 [3]: https://www.readthesequences.com/Talk/Ethical-Injunctions "View the Talk page for “Ethical Injunctions”"
 ...
 [8]: https://www.greaterwrong.com/lw/rr/the_moral_void/
 [9]: https://www.greaterwrong.com/lw/tj/dreams_of_friendliness/
 [10]: https://www.readthesequences.com/MagicalCategories
 [11]: https://www.readthesequences.com/FakeUtilityFunctions
 [12]: https://www.readthesequences.com/TheLevelAboveMine
 [13]: https://www.readthesequences.com/DreamsOfAIDesign
 [14]: https://en.wikipedia.org/wiki/SF%20Hydro
 [15]: #footnote1
 [16]: https://www.readthesequences.com/EndsDontJustifyMeansAmongHumans
 [17]: https://www.greaterwrong.com/lw/uu/why_does_power_corrupt/
 [18]: https://www.greaterwrong.com/lw/uz/protected_from_myself/
 [19]: https://www.readthesequences.com/RaisedInTechnophilia
 [20]: https://www.readthesequences.com/NoSafeDefenseNotEvenScience
 [21]: https://www.readthesequences.com/MotivatedStoppingAndMotivatedContinuation
 [22]: https://www.readthesequences.com/TheThirdAlternative
 [23]: https://www.readthesequences.com/DarkSideEpistemology
 [24]: https://www.greaterwrong.com/lw/v1/ethical_injunctions#comments "View Less Wrong discussion thread for “Ethical Injunctions”"
 [25]: #citation1
 [26]: https://www.readthesequences.com/Book-V-MereGoodness
 [27]: https://www.readthesequences.com/QuantifiedHumanismSequence
 [28]: https://www.readthesequences.com/SomethingToProtect