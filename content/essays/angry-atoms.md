...
Fundamental physics—quarks ’n’ stuff—is far removed from the levels we can [*see*][8], like hands and fingers. At best, you can know how to replicate the experiments that show that your hand (like everything else) is composed of quarks, and you may know how to derive a few equations for things like atoms and electron clouds and molecules. 

At worst, the existence of quarks beneath your hand may just be something you were [told][9]. In which case it’s questionable in what sense you can be said to “know” it at all, even if you repeat back the same word “quark” that a physicist would use to convey knowledge to another physicist. 
...
Try to put yourself in the shoes of the hunter-gatherer who’s never had the “Aha!” of information-processing. Try to avoid [hindsight bias][11] about things like neurons and computers. Only then will you be able to see the uncrossable explanatory gap: 
...
And suppose a cognitive scientist just [flatly tells][15] you “Anger is hormones”? Even if you repeat back the words, it doesn’t mean you’ve crossed the gap. You may [believe you believe it][16], but that’s not the same as understanding what little billiard balls have to do with wanting to hit someone. 
...
These are both tough pills to swallow (not that you *should* swallow them) and so it is a good deal easier to [profess][17] them than to believe them. 
...
[Heat vs. Motion][23]
 ...
 [1]: https://www.readthesequences.com/Angry-Atoms?action=source "View PmWiki source for “Angry Atoms”"
 [2]: https://www.readthesequences.com/Angry-Atoms?action=markdown "View “Angry Atoms” in Markdown format"
 [3]: https://www.readthesequences.com/Talk/Angry-Atoms "View the Talk page for “Angry Atoms”"
 ...
 [8]: https://www.readthesequences.com/HandVsFingers
 [9]: https://www.readthesequences.com/GuessingTheTeachersPassword
 [10]: https://en.wikipedia.org/wiki/Atom
 [11]: https://www.readthesequences.com/FailingToLearnFromHistory
 [12]: https://www.readthesequences.com/TerminalValuesAndInstrumentalValues
 [13]: https://en.wikipedia.org/wiki/minimax
 [14]: https://www.readthesequences.com/TheSimpleTruth
 [15]: https://www.readthesequences.com/FakeReductionism
 [16]: https://www.readthesequences.com/BeliefInBelief
 [17]: https://www.readthesequences.com/ScienceAsAttire
 [18]: https://www.readthesequences.com/HowAnAlgorithmFeelsFromInside
 [19]: https://www.readthesequences.com/WrongQuestions
 [20]: https://www.greaterwrong.com/lw/p3/angry_atoms#comments "View Less Wrong discussion thread for “Angry Atoms”"
 [21]: https://www.readthesequences.com/Book-IV-MereReality
 [22]: https://www.readthesequences.com/Physicalism201Sequence
 [23]: https://www.readthesequences.com/HeatVsMotion