...
Behold the [abyssal cultural gap][8]. If you think you can cross it in a few sentences, you are bound to be sorely disappointed. 
...
Plus, the one takes for granted that a proponent of an idea is expected to defend it against [every possible counterargument][9] and confess nothing. All claims are discounted accordingly. If even the *proponent* of science admits that science is less than perfect, why, it must be pretty much worthless. 
...
One obvious source for this pattern of thought is religion, where the scriptures are alleged to come from God; therefore to confess any flaw in them would destroy their authority utterly; so any trace of doubt is a sin, and [claiming certainty][10] is *mandatory* whether you’re certain or not. 
...
[Reversed stupidity][12] is not intelligence. You can’t arrive at a correct answer by reversing *every single* line of an argument that ends with a bad conclusion—it gives the fool too much detailed control over you. [Every single line][13] must be correct for a mathematical argument to carry. And it doesn’t follow, from the fact that moral relativists say “The world isn’t black and white,” that this is false, any more than it follows, from Stalin’s belief that 2 + 2 = 4, that “2 + 2 = 4” is false. The error (and it only takes one) is in the leap from the two-color view to the single-color view, that all grays are the same shade. 
...
Oh, and: [Logical fallacy: Appeal to consequences of belief][14]. 
...
[How to Convince Me That 2 + 2 = 3][20]

 [1]: https://www.readthesequences.com/Absolute-Authority?action=source "View PmWiki source for “Absolute Authority”"
 [2]: https://www.readthesequences.com/Absolute-Authority?action=markdown "View “Absolute Authority” in Markdown format"
 [3]: https://www.readthesequences.com/Talk/Absolute-Authority "View the Talk page for “Absolute Authority”"
 ...
 [8]: https://www.readthesequences.com/Expecting-Short-Inferential-Distances
 [9]: https://www.readthesequences.com/Policy-Debates-Should-Not-Appear-One-Sided
 [10]: https://www.readthesequences.com/Professing-And-Cheering
 [11]: https://www.readthesequences.com/Focus-Your-Uncertainty
 [12]: https://www.readthesequences.com/Reversed-Stupidity-Is-Not-Intelligence
 [13]: https://www.readthesequences.com/Burdensome-Details
 [14]: http://www.nizkor.org/features/fallacies/appeal-to-consequences.html
 [15]: https://www.readthesequences.com/New-Improved-Lottery
 [16]: https://www.greaterwrong.com/lw/mn/absolute_authority/#comments "View Less Wrong discussion thread for “Absolute Authority”"
 [17]: https://www.readthesequences.com/The-Fallacy-Of-Gray
 [18]: https://www.readthesequences.com/Book-II-How-To-Actually-Change-Your-Mind
 [19]: https://www.readthesequences.com/Overly-Convenient-Excuses-Sequence
 [20]: https://www.readthesequences.com/How-To-Convince-Me-That-Two-Plus-Two-Equals-Three