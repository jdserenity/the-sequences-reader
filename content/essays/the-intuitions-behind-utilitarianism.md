...
Now, what are the “intuitions” upon which my “utilitarianism” depends? This is a deepish sort of topic, but I’ll take a quick stab at it. 
...
After you think about moral problems for a while, and also find new truths about the world, and even discover disturbing [facts about how you yourself work][9], you often end up with different moral opinions than when you started out. This does not quite *define* moral progress, but it is how we experience moral progress. 
...
The question of where a road goes—where it leads—you can answer by traveling the road and finding out. If you have a false belief about where the road leads, this falsity can be [destroyed by the truth][10] in a very direct and straightforward manner. 
...
When you’ve read enough research on [scope insensitivity][11]—people will pay only 28% more to protect all 57 wilderness areas in Ontario than one area, people will pay the same amount to save 50,000 lives as 5,000 lives… that sort of thing… 

Well, the worst case of scope insensitivity I’ve ever heard of was described [here][12] by Slovic: 

> Other recent research shows similar results. Two Israeli psychologists asked people to contribute to a costly life-saving treatment. They could offer that contribution to a group of eight sick children, or to an individual child selected from the group. The target amount needed to save the child (or children) was the same in both cases. Contributions to individual group members far outweighed the contributions to the entire group.[1][13] 
...
(It is a general principle that Bayesians see no difference between the long-run answer and the short-run answer; you [never][14] get two different answers from computing the same question two different ways. But the long run is a helpful intuition pump, so I am talking about it anyway.) 
...
Part of it, clearly, is that primitive intuitions don’t successfully diminish the emotional impact of symbols standing for small quantities—anything you talk about seems like “[an amount worth considering][16].” 
...
It is more important that lives be saved, than that we conform to any particular ritual in saving them. And the optimal path to that destination is governed by [laws that are simple, because they are math][14]. 
...
[![][https://www.readthesequences.com/wiki/uploads/star.svg]][18]
  ...
  Paul Slovic, “Numbed by Numbers,” *Foreign Policy* (March 2007), [http://foreignpolicy.com/­2007/03/13/­numbed-by-numbers/][19]. [↩︎][20] 
...
[Ends Don’t Justify Means (Among Humans)][24]

 [1]: https://www.readthesequences.com/The-Intuitions-Behind-Utilitarianism?action=source "View PmWiki source for “The “Intuitions” Behind “Utilitarianism””"
 [2]: https://www.readthesequences.com/The-Intuitions-Behind-Utilitarianism?action=markdown "View “The “Intuitions” Behind “Utilitarianism”” in Markdown format"
 [3]: https://www.readthesequences.com/Talk/The-Intuitions-Behind-Utilitarianism "View the Talk page for “The “Intuitions” Behind “Utilitarianism””"
 ...
 [8]: https://www.readthesequences.com/APriori
 [9]: https://www.readthesequences.com/TheLensThatSeesItsOwnFlaws
 [10]: https://www.readthesequences.com/Feeling-Rational
 [11]: https://www.readthesequences.com/ScopeInsensitivity
 [12]: http://www.foreignpolicy.com/articles/2007/03/12/numbed_by_numbers
 [13]: #footnote1
 [14]: https://www.readthesequences.com/BeautifulProbability
 [15]: https://www.readthesequences.com/TheAllaisParadox
 [16]: https://www.readthesequences.com/ButTheresStillAChanceRight
 [17]: https://www.readthesequences.com/NotForTheSakeOfHappinessAlone
 [18]: https://www.greaterwrong.com/lw/n9/the_intuitions_behind_utilitarianism#comments "View Less Wrong discussion thread for “The “Intuitions” Behind “Utilitarianism””"
 [19]: http://foreignpolicy.com/2007/03/13/numbed-by-numbers/
 [20]: #citation1
 [21]: https://www.readthesequences.com/FeelingMoral
 [22]: https://www.readthesequences.com/Book-V-MereGoodness
 [23]: https://www.readthesequences.com/QuantifiedHumanismSequence
 [24]: https://www.readthesequences.com/EndsDontJustifyMeansAmongHumans